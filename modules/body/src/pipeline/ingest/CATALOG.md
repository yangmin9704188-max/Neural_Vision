...
- build_curated_v0.py — SizeKorea raw → curated_v0 parquet/csv. In: data/external/sizekorea_raw 7th/8th CSV|XLSX, contracts/measurement/coverage/sizekorea_v2.json. Out: data/derived/curated_v0/<RUN_ID>/curated_v0.parquet. Status: active.
