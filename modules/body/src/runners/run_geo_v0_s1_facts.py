...
def main():
    ...
    try:
        ...
        print(f"[WARN] Facts summary write failed: {e}; writing minimal stub", file=sys.stderr)
        stub = {"schema_version": "facts_summary_v1", "error": str(e), "summary": {"valid_cases": 0}}
        with open(facts_summary_path, 'w', encoding='utf-8') as f:
    ...
    for name, header in (
        ("KPI.md", "# KPI\n\n(Generated by postprocess or stub)\n"),
